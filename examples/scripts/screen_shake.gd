...
#		position.y = remap(ratio,0,2,0,10)
#	else:
#		pass
	position.y = Global.camHeight
	rand.randomize()
...
#	var randomSam = 0.5
#	camera.h_offset = shake_offset.x*delta*randomSam
#	camera.v_offset = shake_offset.y*delta*randomSam
