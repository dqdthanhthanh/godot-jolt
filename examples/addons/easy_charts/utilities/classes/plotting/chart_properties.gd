...
var x_label: String
var y_label: String
var functions_names: PackedStringArray
...
var shapes: Array = [Point.Shape3D.CIRCLE, Point.Shape3D.SQUARE, Point.Shape3D.TRIANGLE, Point.Shape3D.CROSS]
var font: FontFile = Label.new().get_font("")
...
func get_point_shape(function_index: int) -> int:
	return shapes[function_index] if function_index < shapes.size() else Point.Shape3D.CIRCLE
