...
func _enter_tree():
	...
	add_custom_type("EffekseerEmitter", "Node3D", load(plugin_source_path + "/EffekseerEmitter.gdns"), icon)
	...
	add_node_3d_gizmo_plugin(emitter_gizmo_plugin)
	

func _exit_tree():
	remove_node_3d_gizmo_plugin(emitter_gizmo_plugin)
